        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    MeterRental = table.Column<double>(nullable: false),
                    Rate = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BillRate", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaritalState", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AmountOutstanding = table.Column<double>(nullable: false),
                    AmountOwed = table.Column<double>(nullable: false),
                    BillCreatedBy = table.Column<string>(nullable: true),
                    BillLastEditBy = table.Column<string>(nullable: true),
                    BillMonth = table.Column<string>(nullable: true),
                    DateCreated = table.Column<DateTime>(nullable: false),
                    DueDate = table.Column<DateTime>(nullable: false),
                    FromBillingDate = table.Column<DateTime>(nullable: false),
                    NumberofGallsConsumed = table.Column<int>(nullable: false),
                    RateId = table.Column<int>(nullable: false),
                    ToBillingDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaterBills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaterBills_BillRate_RateId",
                        column: x => x.RateId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clients_Streets_StreetId",
                        column: x => x.StreetId,
                        principalTable: "Streets",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientAccounts_AccountStatus_AccountStatusId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientAccounts_Meter_MeterId",
                        column: x => x.MeterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientAccounts_AccountStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientAccounts_MeterId",
                table: "ClientAccounts",
                column: "MeterId");
